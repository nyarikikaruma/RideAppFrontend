<template>
    <div class="pt-16">
        <h1 class="text-3xl font-semibold mb-4">KarumaUber</h1>
            ...
            <div class="bg-white px-4 py-5 sm:p-6">
                <div class="flex justify-between">
                    ...
                    <button @click="findARide"
                        class="rounded-md border border-transparent mx-auto bg-black py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-gray-600 focus:outline-none">
                        Find A Ride
                    </button>
                </div>
            </div>
